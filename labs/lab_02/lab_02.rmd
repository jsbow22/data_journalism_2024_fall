...
**More than 10,000 voters are new registrants, or at least appear to be. **
...
**There are four weeks that seem to be much higher, two of them (starting 7/21 and 7/28) from that period. It does represent a huge jump from the week before (7/14), from 3,883 to 7,126.**
...
**It does a little bit, as July showed the most registrations by a lot. Perhaps this was in anticipation of, and then after, Biden dropped out. ** 
```{r}
md_voters_2024 |> 
...
**One question I would like to have answered is how many democrats versus Republicans registered around Biden's date of pulling out from the election. I would like to see whether the increase in registrations is a Democrat-specific thing, or both parties.** 
