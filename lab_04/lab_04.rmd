...
**Both campaigns spent the most money on advertising, but Hogan was on ad buy while Alsobrooks was media advertising.**
...
clean_md_senate_expenses |>
  group_by(amount, purpose_clean) |>
select(amount, purpose_clean, candidate) |> 
  arrange(desc(amount))
...
**According to research, media advertising is the overall strategy, so Alsobrooks spent more money on the strategy. The ad buy is the process of actually placing the ad. **
...
**For Alsobrooks, the amount of money seems to be increasing over time, which makes sense because the election date is approaching. For Hogan, it's a little more spread out. There is a correlation, as it seems there is slightly more on later dates, but not as much. Perhaps Alsobrooks ramped up spending as the race got closer, while Hogan always faced an uphill battle.**
...
**Alsobrooks spent the most money on Grassroots Media, while Hogan spent the most on M2 PLACEMENT. Alsobrooks has spent much more money than Hogan so far, by almost double. There are 192 unique recipients for Hogan, and 200 for Alsobrooks. **
...
**I think the most interesting story idea is, with this data, how much more money has come out of the Alsobrooks campaign. This is especially interesting considering she has been, throughout the campaign, the presumptive winner.**
