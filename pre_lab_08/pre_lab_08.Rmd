...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **The data has 24 rows and 18 columns.**
...
**The first step loads in the data and creates a column for a new difference, with the new - the old. Then the code creates a new data set, top counties, that arranges, including county and the difference, the top 10 in change.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **An empty space where it looks like a chart should go.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **I see a bar chart with the unaffiliated difference in the bars.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **It is now in ascending order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Now it's vertical, progressing bottom to top, instead of horizontal. It ascends on the y-axis.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **It looks like the code added a minimal theme, which changes the visual.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **It added the Economist theme, changing how the graphic/chart looks.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **It essentially added a title, renamed the x and y axises, and added a caption with a source. This all contributes to greater clarity.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It's the number of contributions by date from the beginning of April to the end of June.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It's a line graph that portrays the number of contributions by date, and how it has gone up and down.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It added specific date labels by week, so that it's not just a breakdown by month on the x-axis.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **It made the date labels on the x-axis tilt at a 45 degree angle, making them look cleaner and, from a practical standpoint, making them easier to read.**
