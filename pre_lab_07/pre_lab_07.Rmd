...
```{r echo=FALSE}
#census_api_key("903a63fa0988fb12a94c244701889b5993fa9d04", install=TRUE)
```
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Howard County**
...
Is the difference between Calvert and Montgomery significant? **No**
...
**Task** Arrange md_zips_with_acs by estimate showing the highest median household income first. What questions do you have about these top zip codes? **My biggest question is how close they are to each other geographically and what the demographic makeup of those zip codes is.**
