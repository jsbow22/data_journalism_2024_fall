...
**Answer:**
**The console returns the same answer as below, "[1] 4"
...
**Answer**
**131,395 observations, 24 variables**
### Task 3: Glimpse data
...
In the space below, write the data type for the "last_name" column and the "amount" columns (it's in light gray, offset by \< \>). Also offer your best guess as to what the "last_name" column and the "amount" column represent. **Last name type is chr, amount might have to do with money?**
...
In the space below, write the first and last name from the _second_ row of the data. **Peggy Mukai**
...
**It's counting total contributions/donations by date, instead of grouping it by name**
...
**Instead of being controverial, the dates are arranged in order of most contributions received**
...
**Seems to be a count of how many contributions there are for each amount? Also includes data about where the contributions went to. It is now grouped by memo text and amount**
...
**Seems to show the total contributions, and the total contribution amount, for different committees or groups. The code is saying to descend by total amount.**
...
**It added mean, median of total amount into the code. It is also arranged by total contributions. The top Maryland result seems ot be Hogan?**
...
Compared to the previous codeblock, what has changed and how did that affect the result? How is the data sorted? **The biggest change is that it is now grouping by city. The data is arranged by city in alphabetical order.**
