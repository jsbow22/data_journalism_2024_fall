...
**It is ading a column for what percentage of the votes were received on election day for each candidate.**
...
**Now the candidates with the highest percentage of votes received on election day are up top. This is because the code has them in descending order based on the newly created column of percent on election day.**
...
**Yes, I think it is. This is because most people think of votes as being cast on election day, so it is more interesting to see candidates who saw more of their votes cast before.**
...
**str_to_lower does the same thing but converts it all to lowercase, while str_to_title makes it so that the first letter of each word is capitalized.**
...
**The mutate statement first creates a new column for amount category. Then, it is labeling donations from different strata. Donations with an amount less than 100, for example, are now labeled "Less than $100"**
...
**The biggest category is donations that total less than $100.** 
...
**So that it is easier to call up and observe going forward.**
...
**It is now arranged in date format, with year, month, day in that order.**
...
**The data on the months are all the first day of the month. I'm guessing that that eliminates the day and just arranges it by month. The data here is showing which months have the highest expenditures.**
