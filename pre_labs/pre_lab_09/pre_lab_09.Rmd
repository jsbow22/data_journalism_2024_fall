...
<<<<<<< HEAD
**https://datawrapper.dwcdn.net/3JeBB/1/** Copy the url of the graphic you published here. It will begin with <https://datawrapper.dwcdn.net/>. Don't copy the browser's current url.
=======
...
>>>>>>> d7261ba6cbe8095fa0e399c83fbe498c2711de46
...
group_by(County)|>
  mutate(total_votes_county = sum(Moore, Cox, Lashar, Wallace, Harding, na.rm = TRUE),
         wes_moore_percentage = (Moore / total_votes_county) * 100)|>
ungroup()
md_gov_county
...
<<<<<<< HEAD
**Task** Look for "Hide regions without data" under Appearance, and click the slider icon to enable that feature. You should see a map zoomed into Maryland with some counties in various colors. **It has cropped the rest of the map out of the picture, zeroing in on Maryland.** Describe the changes from the previous map
=======
...
<<<<<<< HEAD
**Task** Click the "Customize tooltips" button so it expands down. Change {{ fips_code }} to {{ county }} and {{ pctmoore }} to {{ FORMAT(pctmoore, "00.0%")}} **Now when you hover over a county, the percent of votes for Moore comes up with the percentage sign and all.** Describe the changes from the previous map
=======
...
<<<<<<< HEAD
**Task** Click the "Proceed" button until you get to the "Publish & Embed" tab, then click "Publish Now". Copy the published URL (like you did for the chart above) and paste it below. **https://datawrapper.dwcdn.net/gBht2/1/** Put the URL of your map here.
=======
