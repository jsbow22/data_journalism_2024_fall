...
**Task** Run the following code and describe the dataframe it outputs. **It is a database of 999 Ben Cardin press releases, with date, title, URL, and text (4 columns).**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **It seems to remove repeats, only keeping the unique words. Hence, it removed the second "cat."**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **It seems to create a list of all of the unique words in the Ben Cardin releases, yielding more than 677,420 results.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **I really don't think this is that interesting, because it just shows that the most used words are words like "the" and "and." I'm not really sure what this chart is supposed to show.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **It IS more interesting now, and seems to be isolating words that actually have to do with specific issues.**
...
**Task** Run the following code and describe the results. **It creates two dataframes with the most used somewhat interesting words in each year.**
...
**Task** Run the following code and describe the results. **It is showing the top 10 2 word phrases from 2022.**
...
**Task** Run the following code and describe the results. **It is doing the same thing; a noticeable difference is the lack of COVID 19.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **I think most of the sentiments seem to make sense. It's interesting how much more positive there is than negative.**
