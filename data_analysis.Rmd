...
glimpse(emails)
```
There are some problems here that we are going to need to get worked out. The first is that the date format is not in date (at least I don't think so?). I'm not sure how to fix it because the date also includes time. 
